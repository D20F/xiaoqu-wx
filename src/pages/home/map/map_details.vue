        ...
        >
            <swiper-item class="u-swiper-item" v-for="(item, index) in list" :key="index">
                <view class="map_content">
                    <view class="title">
                        <text class="font_weight_black1_36">{{item.place_name}}</text>
                        <text class="font_weight_green1_32">{{item.distance}}</text>
                    </view>
                    <view class="address">
                        <image src="https://img.sporeblockchain.cn/static/map/near_icon_location@3x.png" />
                    ...
                    <view class="time">
                        <image src="https://img.sporeblockchain.cn/static/map/near_icon_time@3x.png" />
                        <text>{{time.start_date}}至</text>
                        <text>{{time.end_date}}</text>
                        <text>{{time.start_time}}</text>
                        <text>-</text>
                        <text>{{time.end_time}}</text>
                    </view>
                    <view class="recycle_content">
                        <view class="row" v-for="(i,index) of item.list" :key="index">
